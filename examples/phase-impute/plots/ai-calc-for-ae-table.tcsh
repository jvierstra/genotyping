...
set indir = results.plots/$dstamp/ai-calc-rnaseq-ae.filteredR2/output/expression/filtered.all
...
set b = (`echo $b | tr ' ' '\n' | sort -g`)
set pngs = Indiv-{`echo $b | tr ' ' ','`}.distr.png
